...
SELECT Id, ACCT_NBR, SYMBOL, SHARES, PUR_PRICE, PUR_DATE FROM HOLDINGS WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, ACCT_NBR, SYMBOL, SHARES, PUR_PRICE, PUR_DATE FROM dbo.HOLDINGS";
        ...
        public virtual int FillBy(Database1DataSet.HOLDINGSDataTable dataTable) {
